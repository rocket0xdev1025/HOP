    ...
    5464: function (e, t, r) {
      ...
      var i = r(7776),
        ...
        s = (() => {
          ...
          return (
            r.setAttribute("position", new i.BufferAttribute(e, 3)),
            r.setAttribute("uv", new i.BufferAttribute(t, 2)),
            r
          );
        })(),
        a = class e {
          ...
          constructor(e = "Pass", t = new i.Scene(), r = new i.Camera()) {
            (this.name = e),
              (this.renderer = null),
              (this.scene = t),
              (this.camera = r),
          ...
          set fullscreenMaterial(t) {
            ...
            null !== r
              ? (r.material = t)
              : (((r = new i.Mesh(e.fullscreenGeometry, t)).frustumCulled = !1),
          ...
          dispose() {
            for (let t of Object.keys(this)) {
              let r = this[t];
              (r instanceof i.WebGLRenderTarget ||
                r instanceof i.Material ||
                r instanceof i.Texture ||
                r instanceof e) &&
                this[t].dispose();
            }
        ...
        u = class extends i.ShaderMaterial {
          constructor() {
            super({
              name: "CopyMaterial",
              uniforms: {
            ...
            void 0 !== r &&
              ...
              r !== i.UnsignedByteType
                ? (this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH =
                    "1")
                : null !== e &&
                  e.outputColorSpace === i.SRGBColorSpace &&
                  (this.renderTarget.texture.colorSpace = i.SRGBColorSpace));
          }
        },
        c = new i.Color(),
        d = class extends a {
        ...
        f = class extends a {
          ...
          render(e, t, r, i, n) {
            ...
            a.color.setMask(!1),
              ...
              a.stencil.setFunc(s.ALWAYS, h, 4294967295),
              a.stencil.setClear(1 - h),
              a.stencil.setLocked(!0),
              this.clearPass.enabled &&
                (this.renderToScreen
                  ? u.render(e, null)
                  : (u.render(e, t), u.render(e, r))),
              this.renderToScreen
                ? e.setRenderTarget(null)
                : (e.setRenderTarget(t), e.render(o, l), e.setRenderTarget(r)),
              e.render(o, l),
              a.color.setLocked(!1),
              a.depth.setLocked(!1),
        ...
        p = class {
          ...
          setRenderer(e) {
            if (((this.renderer = e), null !== e)) {
              ...
              for (let s of (n === i.UnsignedByteType &&
                e.outputColorSpace === i.SRGBColorSpace &&
                ((this.inputBuffer.texture.colorSpace = i.SRGBColorSpace),
                (this.outputBuffer.texture.colorSpace = i.SRGBColorSpace),
                this.inputBuffer.dispose(),
                this.outputBuffer.dispose()),
              (e.autoClear = !1),
          ...
          createBuffer(e, t, r, n) {
            ...
            return (
              n > 0 &&
                ((l.ignoreDepthForMultisampleCopy = !1), (l.samples = n)),
              r === i.UnsignedByteType &&
                null !== s &&
                s.outputColorSpace === i.SRGBColorSpace &&
                (l.texture.colorSpace = i.SRGBColorSpace),
          ...
          render(e) {
            ...
            this.passes))
              h.enabled &&
                ...
                h.needsSwap &&
                  (u &&
                    ((s.renderToScreen = h.renderToScreen),
                    (t = n.getContext()),
                    (r = n.state.buffers.stencil).setFunc(
                      t.NOTEQUAL,
                      1,
                      4294967295
                    ),
                  ...
                  (a = l),
                  (l = i)),
                h instanceof f ? (u = !0) : h instanceof o && (u = !1));
          }
          setSize(e, t, r) {
            let n = this.renderer,
              s = n.getSize(new i.Vector2());
            (void 0 === e || void 0 === t) && ((e = s.width), (t = s.height)),
              (s.width !== e || s.height !== t) && n.setSize(e, t, r);
        ...
        g = class {
          constructor() {
            (this.shaderParts = new Map([
              ...
              (this.readDepth = !1),
              (this.colorSpace = i.LinearSRGBColorSpace);
          }
        },
        S = !1,
        x = class {
        ...
        y = class extends i.EventDispatcher {
          constructor(e, t = -1, r = -1, n = 1) {
            super(),
              (this.resizable = e),
              (this.baseSize = new i.Vector2(1, 1)),
              (this.preferredSize = new i.Vector2(t, r)),
              (this.target = this.preferredSize),
              (this.s = n),
              (this.effectiveSize = new i.Vector2()),
        ...
        E = class extends i.EventDispatcher {
          constructor(e, t = 1) {
            super(),
              (this._blendFunction = e),
              (this.opacity = new i.Uniform(t));
          }
          getOpacity() {
        ...
        M = class extends i.ShaderMaterial {
          ...
          setSize(e, t) {
            let r = 1 / e,
              i = 1 / t;
            this.uniforms.texelSize.value.set(r, i, 0.5 * r, 0.5 * i);
          }
        },
        B = class extends a {
          constructor({
            ...
            let o = (this.resolution = new y(this, s, a, t));
            o.addEventListener("change", (e) =>
              this.setSize(o.baseWidth, o.baseHeight)
            ),
              (this._blurMaterial = new M()),
          ...
          setSize(e, t) {
            ...
            let i = r.width,
              n = r.height;
            this.renderTargetA.setSize(i, n),
              this.renderTargetB.setSize(i, n),
          ...
          initialize(e, t, r) {
            void 0 !== r &&
              ...
              r !== i.UnsignedByteType
                ...
                : null !== e &&
                  e.outputColorSpace === i.SRGBColorSpace &&
                  ((this.renderTargetA.texture.colorSpace = i.SRGBColorSpace),
                  (this.renderTargetB.texture.colorSpace = i.SRGBColorSpace)));
          }
          static get AUTO_SIZE() {
            return y.AUTO_SIZE;
          }
        ...
        A = class extends i.ShaderMaterial {
          constructor(e = !1, t = null) {
            super({
              ...
              defines: { THREE_REVISION: i.REVISION.replace(/\D+/g, "") },
              uniforms: {
                inputBuffer: new i.Uniform(null),
        ...
        R = class extends a {
          constructor({
            ...
            super("LuminancePass"),
              (this.fullscreenMaterial = new A(r, t)),
              (this.needsSwap = !1),
              (this.renderTarget = e),
            ...
            let u = (this.resolution = new y(this, o, l, n));
        ...
        D = class extends a {
          constructor() {
            super("MipmapBlurPass"),
              ...
              (this.downsamplingMaterial = new b()),
              (this.upsamplingMaterial = new C()),
        ...
        _ = class extends i.EventDispatcher {
          constructor(
            e,
            t,
            {
              attributes: r = v.NONE,
              blendFunction: n = T.NORMAL,
              defines: s = new Map(),
              uniforms: a = new Map(),
              extensions: o = null,
              vertexShader: l = null,
            ...
            super(),
              ...
              (this.uniforms = a),
              (this.extensions = o),
              (this.blendMode = new E(n)),
              this.blendMode.addEventListener("change", (e) =>
                this.setChanged()
              ),
              (this._inputColorSpace = i.LinearSRGBColorSpace),
              (this._outputColorSpace = i.NoColorSpace);
          }
          get inputColorSpace() {
          ...
          dispose() {
            for (let e of Object.keys(this)) {
              let t = this[e];
              (t instanceof i.WebGLRenderTarget ||
            ...
            n.enabled
              ? (n.render(e, t),
                this.mipmapBlurPass.enabled
                  ...
                  : this.blurPass.render(e, n.renderTarget, i))
              : this.mipmapBlurPass.enabled
        ...
        I = class extends _ {
          constructor({
            offset: e = new i.Vector2(0.001, 5e-4),
            ...
            super(
              ...
              "#ifdef RADIAL_MODULATION\nuniform float modulationOffset;\n#endif\nvarying float vActive;varying vec2 vUvR;varying vec2 vUvB;void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){vec2 ra=inputColor.ra;vec2 ba=inputColor.ba;\n#ifdef RADIAL_MODULATION\nconst vec2 center=vec2(0.5);float d=distance(uv,center)*2.0;d=max(d-modulationOffset,0.0);if(vActive>0.0&&d>0.0){ra=texture2D(inputBuffer,mix(uv,vUvR,d)).ra;ba=texture2D(inputBuffer,mix(uv,vUvB,d)).ba;}\n#else\nif(vActive>0.0){ra=texture2D(inputBuffer,vUvR).ra;ba=texture2D(inputBuffer,vUvB).ba;}\n#endif\noutputColor=vec4(ra.x,inputColor.g,ba.x,max(max(ra.y,ba.y),inputColor.a));}",
              {
                ...
                uniforms: new Map([
                  ["offset", new i.Uniform(e)],
                  ["modulationOffset", new i.Uniform(r)],
                ]),
              }
            ),
      ...
      var F = class extends a {
          constructor(e, t, r = null) {
            super("RenderPass", e, t),
              ...
              (this.overrideMaterialManager = null === r ? null : new x(r)),
          ...
          set overrideMaterial(e) {
            ...
            null !== e
              ? null !== t
                ? t.setMaterial(e)
                : (this.overrideMaterialManager = new x(e))
              : null !== t &&
      ...
      i.ShaderMaterial,
        ...
        i.ShaderMaterial,
        i.ShaderMaterial;
      var L = class extends i.ShaderMaterial {
          constructor() {
            super({
        ...
        H = class extends a {
          constructor({
            ...
            let l = (this.resolution = new y(this, s, a, t));
      ...
      var G = class extends _ {
        constructor({
          blendFunction: e,
          eskil: t = !1,
          technique: r = t ? P.ESKIL : P.DEFAULT,
          offset: n = 0.5,
          darkness: s = 0.5,
        } = {}) {
          super(
        ...
        get eskil() {
          return this.technique === P.ESKIL;
        }
        set eskil(e) {
          this.technique = e ? P.ESKIL : P.DEFAULT;
        }
        getTechnique() {
      ...
      i.ShaderMaterial, i.ShaderMaterial;
      var k = class extends i.ShaderMaterial {
          ...
          return (
            (this.fragmentShader =
              "#include <common>\n#include <packing>\n#include <dithering_pars_fragment>\n#define packFloatToRGBA(v) packDepthToRGBA(v)\n#define unpackRGBAToFloat(v) unpackRGBAToDepth(v)\n#ifdef FRAMEBUFFER_PRECISION_HIGH\nuniform mediump sampler2D inputBuffer;\n#else\nuniform lowp sampler2D inputBuffer;\n#endif\n#if DEPTH_PACKING == 3201\nuniform lowp sampler2D depthBuffer;\n#elif defined(GL_FRAGMENT_PRECISION_HIGH)\nuniform highp sampler2D depthBuffer;\n#else\nuniform mediump sampler2D depthBuffer;\n#endif\nuniform vec2 resolution;uniform vec2 texelSize;uniform float cameraNear;uniform float cameraFar;uniform float aspect;uniform float time;varying vec2 vUv;vec4 sRGBToLinear(const in vec4 value){return vec4(mix(pow(value.rgb*0.9478672986+vec3(0.0521327014),vec3(2.4)),value.rgb*0.0773993808,vec3(lessThanEqual(value.rgb,vec3(0.04045)))),value.a);}float readDepth(const in vec2 uv){\n#if DEPTH_PACKING == 3201\nreturn unpackRGBAToDepth(texture2D(depthBuffer,uv));\n#else\nreturn texture2D(depthBuffer,uv).r;\n#endif\n}float getViewZ(const in float depth){\n#ifdef PERSPECTIVE_CAMERA\nreturn perspectiveDepthToViewZ(depth,cameraNear,cameraFar);\n#else\nreturn orthographicDepthToViewZ(depth,cameraNear,cameraFar);\n#endif\n}vec3 RGBToHCV(const in vec3 RGB){vec4 P=mix(vec4(RGB.bg,-1.0,2.0/3.0),vec4(RGB.gb,0.0,-1.0/3.0),step(RGB.b,RGB.g));vec4 Q=mix(vec4(P.xyw,RGB.r),vec4(RGB.r,P.yzx),step(P.x,RGB.r));float C=Q.x-min(Q.w,Q.y);float H=abs((Q.w-Q.y)/(6.0*C+EPSILON)+Q.z);return vec3(H,C,Q.x);}vec3 RGBToHSL(const in vec3 RGB){vec3 HCV=RGBToHCV(RGB);float L=HCV.z-HCV.y*0.5;float S=HCV.y/(1.0-abs(L*2.0-1.0)+EPSILON);return vec3(HCV.x,S,L);}vec3 HueToRGB(const in float H){float R=abs(H*6.0-3.0)-1.0;float G=2.0-abs(H*6.0-2.0);float B=2.0-abs(H*6.0-4.0);return clamp(vec3(R,G,B),0.0,1.0);}vec3 HSLToRGB(const in vec3 HSL){vec3 RGB=HueToRGB(HSL.x);float C=(1.0-abs(2.0*HSL.z-1.0))*HSL.y;return(RGB-0.5)*C+HSL.z;}FRAGMENT_HEAD void main(){FRAGMENT_MAIN_UV vec4 color0=texture2D(inputBuffer,UV);vec4 color1=vec4(0.0);FRAGMENT_MAIN_IMAGE color0.a=clamp(color0.a,0.0,1.0);gl_FragColor=color0;\n#ifdef ENCODE_OUTPUT\n#include <colorspace_fragment>\n#endif\n#include <dithering_fragment>\n}"
                ...
                .replace(m.FRAGMENT_MAIN_UV, e.get(m.FRAGMENT_MAIN_UV) || "")
                .replace(
      ...
      i.ShaderMaterial, i.REVISION.replace(/\D+/g, "");
      var V = 255 / 256;
      function W(e, t, r) {
        for (let i of t) {
          ...
          for (let e of r.entries())
            null !== e[1] && r.set(e[0], e[1].replace(n, t));
        }
      }
      new Float32Array([
        255 / 256 / 16777216,
        ...
        new Float32Array([V, V / 256, V / 65536, 1 / 16777216]);
      var K = class extends a {
          constructor(e, ...t) {
            super("EffectPass"),
              (this.fullscreenMaterial = new k(null, null, null, e)),
          ...
          updateMaterial() {
            ...
            for (let r of this.effects)
              if (r.blendMode.blendFunction === T.DST)
                e.attributes |= r.getAttributes() & v.DEPTH;
              else if ((e.attributes & r.getAttributes() & v.CONVOLUTION) != 0)
                ...
                !(function (e, t, r) {
                  ...
                  if (((r.attributes |= t.getAttributes()), void 0 === n))
                    throw Error(`Missing fragment shader (${t.name})`);
                  if (o && (r.attributes & v.CONVOLUTION) != 0)
                    throw Error(
...
`),
                      ...
                      for (let t of ((p +=
                        `	${e}MainSupport(` +
                        (/mainSupport *\([\w\s]*?uv\s*?\)/.test(s)
                          ? "vUv);\n"
                          : ");\n")),
                      s.matchAll(/(?:varying\s+\w+\s+([\S\s]*?);)/g)))
                        for (let e of t[1].split(/\s*,\s*/))
                          r.varyings.add(e), g.add(e), S.add(e);
                      for (let e of s.matchAll(l)) S.add(e[1]);
                    }
                    for (let e of n.matchAll(l)) S.add(e[1]);
                    ...
                    if ((r.blendModes.set(y.blendFunction, y), a)) {
                      null !== t.inputColorSpace &&
                        ...
                        (d +=
                          t.inputColorSpace === i.SRGBColorSpace
                            ? "color0 = sRGBTransferOETF(color0);\n	"
                            : "color0 = sRGBToLinear(color0);\n	"),
                        t.outputColorSpace !== i.NoColorSpace
                          ? (r.colorSpace = t.outputColorSpace)
                          : null !== t.inputColorSpace &&
                            (r.colorSpace = t.inputColorSpace),
                        (d += `${e}MainImage(color0, UV, `),
                        (r.attributes & v.DEPTH) != 0 &&
                          /MainImage *\([\w\s,]*?depth[\w\s,]*?\)/.test(n) &&
                          ((d += "depth, "), (r.readDepth = !0)),
                        (d += "color1);\n	");
                      let s = e + "BlendOpacity";
                      r.uniforms.set(s, y.opacity),
                        (d += `color0 = blend${y.blendFunction}(color0, color1, ${s});
...
`);
            ...
            let r = e.shaderParts.get(m.FRAGMENT_HEAD),
              n = e.shaderParts.get(m.FRAGMENT_MAIN_IMAGE),
          ...
          setSize(e, t) {
            for (let r of (this.fullscreenMaterial.setSize(e, t), this.effects))
              r.setSize(e, t);
          }
          initialize(e, t, r) {
            for (let i of ((this.renderer = e), this.effects))
              i.initialize(e, t, r);
            this.updateMaterial(),
              void 0 !== r &&
                r !== i.UnsignedByteType &&
        ...
        X = class extends a {
          constructor(
            ...
            super("NormalPass"),
              (this.needsSwap = !1),
              (this.renderPass = new F(e, t, new i.MeshNormalMaterial()));
            let u = this.renderPass;
            (u.ignoreBackground = !0), (u.skipShadowMapUpdate = !0);
            let h = u.getClearPass();
            (h.overrideClearColor = new i.Color(7829503)),
            ...
            let c = (this.resolution = new y(this, o, l, n));
      ...
      function j(e, t, r, i) {
        var n;
        return (n = e + (t - e) * 0.75) + (r + (i - r) * 0.75 - n) * 0.875;
      }
      new Float32Array(3),
        new Float32Array(3),
        new Float32Array(3),
