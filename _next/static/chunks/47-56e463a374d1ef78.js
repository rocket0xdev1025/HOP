  ...
  [47],
  {
    ...
    5305: function (e) {
      ...
      if ("object" == typeof document && document.implementation) {
        ...
        s = function (e, t) {
          return (
            t
              ? (f.documentElement.querySelector(t).innerHTML = e)
              : (f.documentElement.innerHTML = e),
            f
          );
        };
      }
      ...
      d.content &&
        ...
        (e.exports = function (e) {
          ...
          switch ((h && h[1] && (u = h[1].toLowerCase()), u)) {
            ...
            case o:
              if (
                ((d = (p = s(e)).querySelectorAll(u)), l.test(e) && a.test(e))
              )
                return d[0].parentNode.childNodes;
              return d;
            default:
              if (t) return t(e);
    ...
    6082: function (e, t, n) {
      for (
        var r,
          o = n(8131),
          i = n(1694).CASE_SENSITIVE_TAG_NAMES,
          a = o.Comment,
          l = o.Element,
        ...
        (t.formatDOM = function e(t, n, r) {
          ...
          for (var o = [], i = 0, p = t.length; i < p; i++) {
            ...
            switch (g.nodeType) {
              case 1:
                (m = new l(
                  (h = u[(f = (f = g.nodeName).toLowerCase())] || f),
                  d(g.attributes)
                )).children = e(
                  "template" === h ? g.content.childNodes : g.childNodes,
                  m
                );
                break;
              case 3:
    ...
    5171: function (e, t, n) {
      ...
      (s.domToReact = a),
        ...
        (s.Comment = r.Comment),
        (s.Element = r.Element),
        (s.ProcessingInstruction = r.ProcessingInstruction),
        (s.Text = r.Text),
        (e.exports = s),
        (s.default = s);
    },
      ...
      e.exports = function e(t, n) {
        for (
          ...
          if (((s = t[x]), v && g((u = n.replace(s))))) {
            k > 1 && (u = h(u, { key: u.key || x })), y.push(u);
            continue;
          }
          if ("text" === s.type) {
            if (
              ((c = !s.data.trim().length) && s.parent && !l(s.parent)) ||
              (b && c)
            )
              continue;
            y.push(s.data);
          ...
          switch (
            ...
            "tag" === s.type &&
            i.isCustomComponent(s.name, s.attribs)
              ? a(p.style, p)
              : p && (p = o(p, s.name)),
            (f = null),
            s.type)
            ...
            case "style":
              s.children[0] &&
                (p.dangerouslySetInnerHTML = { __html: s.children[0].data });
              break;
            case "tag":
              "textarea" === s.name && s.children[0]
                ? (p.defaultValue = s.children[0].data)
                : s.children && s.children.length && (f = e(s.children, n));
              break;
            default:
              continue;
          }
          k > 1 && (p.key = x), y.push(m(s.name, p, f));
        }
            ...
            for (
              ...
              (e = (function () {
                var e = d(),
                  n = y(o);
                if (n) {
                  if ((b(), !y(i))) return g("property missing ':'");
                  var r = y(a),
                    s = e({
                      type: "declaration",
    ...
    5553: function (e, t) {
      ...
      t.camelCase = function (e, t) {
        var c;
        return (void 0 === t && (t = {}), !(c = e) || o.test(c) || n.test(c))
          ? e
          : ((e = e.toLowerCase()),
    ...
    8008: function (e, t, n) {
      ...
      function o(e, t) {
        ...
        for (
          var l = r(e), s = "function" == typeof t, c = 0, u = l.length;
          c < u;
          c++
        )
          (o = (n = l[c]).property),
            (i = n.value),
            s ? t(o, i, n) : i && (a || (a = {}), (a[o] = i));
        return a;
      }
    ...
    4894: function (e) {
      e.exports = {
        style: {
          fontFamily: "'__Space_Mono_e8b655', '__Space_Mono_Fallback_e8b655'",
          fontStyle: "normal",
        },
